...
const KEY_COMPLETION_MAX_TOKENS = 500;
...
const keyInstructions = {
  framing: [
    ...
    "Assumptions policy:",
    "- If data is missing, add Assumption lines with confidence and impact.",
  ].join("\n"),
  unknowns: [
    ...
    "Assumptions policy:",
    "- If you introduce new unknowns, mark dependencies as assumptions when needed.",
  ].join("\n"),
  solution_space: [
    "Card: Solution space",
    "Purpose:",
    ...
    "- Each direction must explicitly cite unknowns or assumptions.",
    "- Max 7 directions.",
    "Assumptions policy:",
  ...
  decision: [
    ...
    "- Pick: <A/B/C/...>",
    "- Why (tie to unknowns + expected learning):",
    "  - ...",
    "- Key trade-offs:",
    "  - ...",
    "",
    ...
    "- Include 2–4 fast checks.",
    "Assumptions policy:",
    "- If data is missing, add at least one explicit Assumption line.",
  ].join("\n"),
  experiment_plan: [
    ...
    "Input dependencies:",
    "- Uses decision + unknowns from Case File.",
    "Output format (strict):",
    ...
    "",
    "### Metrics definitions (no numbers unless given)",
    "- Leading:",
    ...
    "",
    "Quality rules:",
    "- Do not invent targets, sample sizes, or timelines.",
    "- Each test must tie back to unknowns.",
    "Assumptions policy:",
    "- If data is missing, add Assumption lines with confidence.",
  ].join("\n"),
  work_package: [
    "Card: Work package",
    "Purpose:",
